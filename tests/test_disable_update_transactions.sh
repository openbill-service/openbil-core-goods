...
./tests/assert_result.sh "insert into OPENBILL_TRANSACTIONS (amount_cents, amount_currency, from_account_id, to_account_id, uri, details) values (100, 'USD', 1, 2, 'gid://order1', 'test')" 'INSERT 0 1' && \
