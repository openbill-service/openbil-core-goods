...
./tests/assert_result.sh "insert into OPENBILL_TRANSACTIONS (amount_cents, amount_currency, from_account_id, to_account_id, uri, details) values (100, 'USA', 1, 2, 'gid://order1', 'test');" "ERROR:  Account (from #1) has wrong currency" && \
